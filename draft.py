...
cycles=np.array([0,13,14,21,42,2760,2761,2768,7345,7804,43583,43590,43929,46379,46400,51543,52265,54114,56960,59346,59833])-int(59833/2)
...
setting_txt='num_resample='+str(N)+'\n'
